...
class _AsistenciaPageState extends State<AsistenciaPage> {
                        ...
                        return Theme(
                          ...
                          child: ExpansionTile(
                            ...
                            children: [
                              ...
                              // 1. INSTITUCIONES
                              _buildDropdown(
                                  "Institución", state.instituciones, instId,
                                  (val) {
                              ...
                              // Dropdown de Sedes
                              _buildDropdown("Sede", state.sedes, sedeId,
                                  (val) {
                              ...
                              // 3. GRADOS
                              _buildDropdown("Grado", state.grados, gradoId,
                                  (val) {
                              ...
                              // 3. GRUPO
                              _buildDropdown("Grupo", state.grupos, grupoId,
                                  (val) {
                              ...
                              // 3. GRUPO
                              _buildDropdown("Complemento", state.complementos,
                                  complementoId, (val) {
  ...
  void _checkAutoSelect(AsistenciaState state) {
    ...
    if (state.grupos.length == 1 && grupoId == null) {
      ...
      if (id.isNotEmpty && sedeId != null && gradoId != null) {
        setState(() => grupoId = id);
        context
            .read<AsistenciaCubit>()
            .cargarComplementos(sedeId!, gradoId!, id);
      }
    }
