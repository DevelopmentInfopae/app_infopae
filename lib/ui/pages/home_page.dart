    ...
    return Scaffold(
                    ...
                    children: [
                      TextSpan(
                        ...
                        style: TextStyle(
                          ...
                          fontSize: 28, // Bajé un poco de 30 para que no se vea tan apretado
                        ),
                      ),
                      TextSpan(
                        text: 'PAE',
            ...
            Center(
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: const Color(0XFF18a34c), width: 2), // Borde naranja decorativo
                ),
                child: CircleAvatar(
                 radius: 22,
        ...
        child: Column(
          ...
          children: [
            ...
            _buildFeatureCard(
              ...
              subtitle : "Visualiza el resumen de asistencias y entregas realizadas.",
     ...
     bottomNavigationBar: NavigationBar(
        ...
        onDestinationSelected: (int index) {
          if (index == 5) { 
            // Lógica especial para el botón de Salir
            // _mostrarDialogoCerrarSesion(context);
          } else {
            // Actualiza el estado para cambiar de página
            setState(() {
        ...
        destinations: const [
          ...
          NavigationDestination(icon: Icon(Icons.how_to_reg_rounded), label: 'Asistencia'),
          ...
          NavigationDestination(icon: Icon(Icons.logout_rounded), label: 'Salir'),
        ],
      ),
    );
  }
